...
async def handle_start_command(event):
    ...
    prompt = "Hello gess, ini adalah BOT untuk menanyakan sesuatu....."
    try:
        # Greet the user
        ...
        async with client.conversation(await event.get_chat(), exclusive=True, timeout=600) as conv:
            ...
            while True:
                ...
                prompt = "Coba tanyain lagi apa yang mau di tanya?"
                ...
                if user_input is None:
                    ...
                    prompt = "Percakapan akan di reseett, thanksss euyyy!"
                    await client.send_message(SENDER, prompt)
                    break
                else:
                    # Send a "I'm thinking message..."
                    prompt = "Bentarr, saya pikirr dulu yaa ....."
